    ...
    class userDAL
    {
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@added_date", u.added_time);
                ...
                // if the query is executed Succesfully then the value will be greater than 0 else it will be less than 0
                if (rows > 0)
                {
                    //Query Succesful
                    isSucces = true;

...
namespace AnyStore.DAL
{
    class DeaCustDAL
    {
        ...
        #region Select Method for Dealer and Costumer
        ...
        #endregion
        #region Insert Method to add details of Dealer or Costumer
        ...
        #endregion
        #region Update method for Dealer and Costumer
        ...
        #endregion
        #region Delete method for Dealer and Costumer
        ...
        #endregion
        #region Search method for dealer and Costumer 
        public DataTable Search(string keyword)
        {
            //Create e Sql connection
            SqlConnection conn = new SqlConnection(myconnstrng);
        ...
        #endregion
        #region Method to search Dealer or Costumer for Transaction Module
        public DeaCustBLL SearchDealerCostumerForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                //If we have values on DT we need to save it to DealerCostumer BLL
                if (dt.Rows.Count > 0)
                {
        ...
        #endregion
        #region Method to get ID from DEaler or Costumer based on name
